...
public class remRoom extends JFrame {
    ...
    public remRoom(){
        setTitle("Hotel Reservation System - Remove Room");
        setSize(600,500);
        ...
        JLabel title = new JLabel("   Remove a room");
        ...
        CenterPanel2.add(new JPanel());
        CenterPanel2.add(new JLabel("Room Name: "));
