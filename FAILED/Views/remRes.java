...
public class remRes extends JFrame {
    ...
    public remRes(){
        setTitle("Hotel Reservation System - Remove Reservation");
        setSize(600,500);
        ...
        JLabel title = new JLabel("   Remove a Reservation");
        ...
        CenterPanel2.add(new JPanel());
        CenterPanel2.add(new JLabel("Reservation Name: "));
