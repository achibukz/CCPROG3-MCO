...
public class remHot extends JFrame {
    ...
    public remHot(){
        setTitle("Hotel Reservation System - Remove a Hotel");
        setSize(600,500);
        ...
        JLabel title = new JLabel("   Remove a Hotel:");
        ...
        CenterPanel2.add(new JPanel());
        CenterPanel2.add(new JLabel("Hotel Name: "));
