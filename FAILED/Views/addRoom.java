...
public class addRoom extends JFrame {
    ...
    public void addStdButListener(ActionListener listenForStd){
        std.addActionListener(listenForStd);
    }

    public void addDeButlListener(ActionListener listenForDel){
        del.addActionListener(listenForDel);
    }

    public void addExeButListener(ActionListener listenForExe){
        exe.addActionListener(listenForExe);
    }

    public void addConfirmListener(ActionListener listenForConfirm){
        addRoomBut.addActionListener(listenForConfirm);
    }

    public int getnumRooms(){
        return Integer.parseInt(addRoom.getText());
    }
